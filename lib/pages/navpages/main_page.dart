      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          const BottomNavigationBarItem(
              label: 'Home', icon: Icon(Icons.apps)), //Home
          const BottomNavigationBarItem(
              label: 'Bar', icon: Icon(Icons.bar_chart_sharp)), //Bar
          const BottomNavigationBarItem(
              label: 'Search', icon: Icon(Icons.search)), //Search
          const BottomNavigationBarItem(
              label: 'My', icon: Icon(Icons.person)), //My
        ],
      ),
    );
  }
